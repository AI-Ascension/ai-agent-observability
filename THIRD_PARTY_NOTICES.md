...
| Alpine | `docker.io/library/alpine:3.22.1` | [Alpine Linux](https://www.alpinelinux.org/), MIT license; used only for the Collector volume ownership initializer and documented backup/restore helper |
